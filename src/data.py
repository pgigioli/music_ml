...
class NSynthDataset(Dataset):
    def __init__(self, bucket, nsynth_path, instrument_sources=(0, 1, 2), feature_type='mfcc'):
        self.bucket = bucket
        ...
        self.meta = dict([(k, v) for k, v in self.meta.items() if v['instrument_source'] in instrument_sources])
